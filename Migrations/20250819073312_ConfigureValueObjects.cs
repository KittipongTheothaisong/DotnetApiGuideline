...
namespace DotnetApiGuideline.Migrations
{
    ...
    public partial class ConfigureValueObjects : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    shipping_address_street = table.Column<string>(
                        type: "nvarchar(max)",
                        nullable: false
                    ),
                    shipping_address_city = table.Column<string>(
                        type: "nvarchar(max)",
                        nullable: false
                    ),
                    shipping_address_state = table.Column<string>(
                        type: "nvarchar(max)",
                        nullable: false
                    ),
                    shipping_address_country = table.Column<string>(
                        type: "nvarchar(max)",
                        nullable: false
                    ),
                    shipping_address_zip_code = table.Column<string>(
                        type: "nvarchar(max)",
                        nullable: false
                    ),
        ...
        {
            migrationBuilder.DropTable(name: "OrderItemEntity");
